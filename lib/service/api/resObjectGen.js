...
Parser.prototype = {
    ...
    _replaceAnno: function(str) {
        ...
        return str.replace(annoReg, function() {
    ...
    /**
     * resolve the statement, and a flag imply
     * if need to be converted into Number
     *
     * @param  {String} statment
     * @param  {Boolean} flag
     * @return {String/Number}
     */
    _resolveStatment: function(statement, numFlag) {
        var _this = this,
     ...
     */
     _getElValue: function(key) {
        ...
        return this._getIteratInfo(key);
     },
